          ...
          <div className="m-5 md:mb-4">
            ...
            {/* cartitem */}
              {selector.map((datas, index) => (
                <div className=" md:w-fit md:flex md:flex-row bg-white p-5 rounded-lg" key={index}>
                      <div className=" md:mr-5" >
                        {imgUrls[index] && (
                          <img src={imgUrls[index]} className="w-72" alt="Blue Jeans Jacket" />
                        )}
                      </div>
