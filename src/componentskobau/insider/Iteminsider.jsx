...
import { laptopError, laptopLoading, laptopdataid,cart } from "../../features/Laptopslice";
...
const Iteminsider = () => {
  ...
  const handlecart = () => {
    const totalPrice= laptopdtabyid.price * no;
    dispatch(addtocart({...laptopdtabyid,quantity:no,totalPrice}));
  };
